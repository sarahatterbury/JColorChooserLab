 ...
 */
public class ColorChooserPanel extends javax.swing.JPanel implements ChangeListener{
    ...
    public ColorChooserPanel() {
        ...
        Document red = redDisplay.getDocument();
        red.addDocumentListener(new ColorDocumentListener(redDisplay, sldRed));
        Document green = greenDisplay.getDocument();
        green.addDocumentListener(new ColorDocumentListener(greenDisplay, sldGreen));
        Document blue = blueDisplay.getDocument();
        blue.addDocumentListener(new ColorDocumentListener(blueDisplay, sldBlue));
